...
namespace YTVisionPro.Node
{
    public partial class ImageROIEditControl : UserControl
    {
        ...
        //private Point mousePosition; // 用于存储鼠标位置
        /// <summary>
        /// pictureBox重绘事件
        /// </summary>
        /// <param name="sender"></param>
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            //// 如果鼠标在 PictureBox 内，则绘制坐标
            //if (/*pictureBox1.ClientRectangle.Contains(mousePosition)*/true)
            //{
            //    // 绘制鼠标坐标
            //    g.DrawString($"X: {mousePosition.X}, Y: {mousePosition.Y}", font, brush, mousePosition);
            //}
